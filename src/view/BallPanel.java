...
public class BallPanel extends JPanel implements Runnable{
	...
	// Hintergundbild f�r den Ball
	private JLabel bgpic = null;
	
	// Da quadratisch nur eine L�ngenangabe
	...
	/**
	 * Konstruktor des Balls mit �bergabe des Fensters in dem er dargestellt wird
	 * 
	 * @param fenster
	 */
	...
	/**
	 * �berpr�ft ob der Ball einen Spielerbalken ber�hrt hat, oder ob die Spielrunde vorbei ist
	 * Wenn die Spielrunde vorbei ist bekommt der Spieler der gewonnen hat einen Punkt
	 * 
	 * @param	spieler - Balken der ber�hrt worden sein soll
	 * @return	Hat der Ball den Balken ber�hrt?
	 */
	...
	/**
	 * Bewegt den Ball permanent auf der Oberfl�che bis der Thread gestoppt wurde
	 * Startrichtung wird zuf�llig gew�hlt
	 */
	@Override
	public void run() {
